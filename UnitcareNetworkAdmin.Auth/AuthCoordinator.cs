...
namespace UnitcareNetworkAdmin.Auth
{
    public class AuthCoordinator
    {
        ...
        private readonly AuthOptions statelessAuthOptions;
        private readonly Func<IDictionary<string, object>, Task> nextFunc;
        private const string ServerUser = "server.User";

        public AuthCoordinator(Func<IDictionary<string, object>, Task> nextFunc, ITokenValidator tokenValidator, AuthOptions statelessAuthOptions)
        {
